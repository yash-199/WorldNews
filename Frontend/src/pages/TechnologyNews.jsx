...
const TechnologyNews = () => {
    ...
    return (
        <div className='w-full mt-16 px-4 md:px-6 lg:px-10 xl:px-16'>
            <h1 className='text-center text-3xl md:text-4xl font-semibold text-black mb-8'>Techonolgy News</h1>
                    ...
                    >
                        <div className='relative mb-6'>
                            <img
                                ...
                                alt="Main topic"
                            />
                            <p className='absolute right-4 transform -translate-y-1/2 text-white text-sm bg-blue-700 px-3 py-1 rounded' style={{ top: "12%" }}>Technology</p>
